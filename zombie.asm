...
printint(int fd, int xx, int base, int sgn)
{
 ...
 39a:	0f b6 80 64 08 00 00 	movzbl 0x864(%eax),%eax
...
000005b8 <free>:
 ...
 5c7:	a1 80 08 00 00       	mov    0x880,%eax
 ...
 688:	a3 80 08 00 00       	mov    %eax,0x880
 68d:	c9                   	leave  
 68e:	c3                   	ret    
...
0000068f <morecore>:
 ...
 6e0:	a1 80 08 00 00       	mov    0x880,%eax
 6e5:	c9                   	leave  
 6e6:	c3                   	ret    
...
000006e7 <malloc>:
 ...
 6fc:	a1 80 08 00 00       	mov    0x880,%eax
 701:	89 45 f0             	mov    %eax,-0x10(%ebp)
 704:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 708:	75 23                	jne    72d <malloc+0x46>
 70a:	c7 45 f0 78 08 00 00 	movl   $0x878,-0x10(%ebp)
 711:	8b 45 f0             	mov    -0x10(%ebp),%eax
 714:	a3 80 08 00 00       	mov    %eax,0x880
 719:	a1 80 08 00 00       	mov    0x880,%eax
 71e:	a3 78 08 00 00       	mov    %eax,0x878
 723:	c7 05 7c 08 00 00 00 	movl   $0x0,0x87c
 72a:	00 00 00 
