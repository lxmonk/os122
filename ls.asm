...
fmtname(char *path)
{
  ...
  5f:	c7 04 24 d4 0b 00 00 	movl   $0xbd4,(%esp)
  ...
  8a:	05 d4 0b 00 00       	add    $0xbd4,%eax
  ...
  return buf;
  a3:	b8 d4 0b 00 00       	mov    $0xbd4,%eax
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 6ca:	0f b6 80 c0 0b 00 00 	movzbl 0xbc0(%eax),%eax
...
000008e8 <free>:
 ...
 8f7:	a1 ec 0b 00 00       	mov    0xbec,%eax
 ...
 9b8:	a3 ec 0b 00 00       	mov    %eax,0xbec
 9bd:	c9                   	leave  
 9be:	c3                   	ret    
...
000009bf <morecore>:
 ...
 a10:	a1 ec 0b 00 00       	mov    0xbec,%eax
 a15:	c9                   	leave  
 a16:	c3                   	ret    
...
00000a17 <malloc>:
 ...
 a2c:	a1 ec 0b 00 00       	mov    0xbec,%eax
 a31:	89 45 f0             	mov    %eax,-0x10(%ebp)
 a34:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 a38:	75 23                	jne    a5d <malloc+0x46>
 a3a:	c7 45 f0 e4 0b 00 00 	movl   $0xbe4,-0x10(%ebp)
 a41:	8b 45 f0             	mov    -0x10(%ebp),%eax
 a44:	a3 ec 0b 00 00       	mov    %eax,0xbec
 a49:	a1 ec 0b 00 00       	mov    0xbec,%eax
 a4e:	a3 e4 0b 00 00       	mov    %eax,0xbe4
 a53:	c7 05 e8 0b 00 00 00 	movl   $0x0,0xbe8
 a5a:	00 00 00 
