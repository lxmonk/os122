...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3de:	0f b6 80 94 08 00 00 	movzbl 0x894(%eax),%eax
...
000005fc <free>:
 ...
 60b:	a1 b0 08 00 00       	mov    0x8b0,%eax
 ...
 6cc:	a3 b0 08 00 00       	mov    %eax,0x8b0
 6d1:	c9                   	leave  
 6d2:	c3                   	ret    
...
000006d3 <morecore>:
 ...
 724:	a1 b0 08 00 00       	mov    0x8b0,%eax
 729:	c9                   	leave  
 72a:	c3                   	ret    
...
0000072b <malloc>:
 ...
 740:	a1 b0 08 00 00       	mov    0x8b0,%eax
 745:	89 45 f0             	mov    %eax,-0x10(%ebp)
 748:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 74c:	75 23                	jne    771 <malloc+0x46>
 74e:	c7 45 f0 a8 08 00 00 	movl   $0x8a8,-0x10(%ebp)
 755:	8b 45 f0             	mov    -0x10(%ebp),%eax
 758:	a3 b0 08 00 00       	mov    %eax,0x8b0
 75d:	a1 b0 08 00 00       	mov    0x8b0,%eax
 762:	a3 a8 08 00 00       	mov    %eax,0x8a8
 767:	c7 05 ac 08 00 00 00 	movl   $0x0,0x8ac
 76e:	00 00 00 
 ...
 7c4:	a3 b0 08 00 00       	mov    %eax,0x8b0
 7c9:	8b 45 f4             	mov    -0xc(%ebp),%eax
 7cc:	83 c0 08             	add    $0x8,%eax
 7cf:	eb 38                	jmp    809 <malloc+0xde>
 7d1:	a1 b0 08 00 00       	mov    0x8b0,%eax
