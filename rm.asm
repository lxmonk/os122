...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3fa:	0f b6 80 d4 08 00 00 	movzbl 0x8d4(%eax),%eax
...
00000618 <free>:
 ...
 627:	a1 f0 08 00 00       	mov    0x8f0,%eax
 ...
 6e8:	a3 f0 08 00 00       	mov    %eax,0x8f0
 6ed:	c9                   	leave  
 6ee:	c3                   	ret    
...
000006ef <morecore>:
 ...
 740:	a1 f0 08 00 00       	mov    0x8f0,%eax
 745:	c9                   	leave  
 746:	c3                   	ret    
...
00000747 <malloc>:
 ...
 75c:	a1 f0 08 00 00       	mov    0x8f0,%eax
 761:	89 45 f0             	mov    %eax,-0x10(%ebp)
 764:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 768:	75 23                	jne    78d <malloc+0x46>
 76a:	c7 45 f0 e8 08 00 00 	movl   $0x8e8,-0x10(%ebp)
 771:	8b 45 f0             	mov    -0x10(%ebp),%eax
 774:	a3 f0 08 00 00       	mov    %eax,0x8f0
 779:	a1 f0 08 00 00       	mov    0x8f0,%eax
 77e:	a3 e8 08 00 00       	mov    %eax,0x8e8
 783:	c7 05 ec 08 00 00 00 	movl   $0x0,0x8ec
 78a:	00 00 00 
 ...
 7e0:	a3 f0 08 00 00       	mov    %eax,0x8f0
 7e5:	8b 45 f4             	mov    -0xc(%ebp),%eax
 7e8:	83 c0 08             	add    $0x8,%eax
 7eb:	eb 38                	jmp    825 <malloc+0xde>
 7ed:	a1 f0 08 00 00       	mov    0x8f0,%eax
