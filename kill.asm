...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3da:	0f b6 80 9c 08 00 00 	movzbl 0x89c(%eax),%eax
...
000005f8 <free>:
 ...
 607:	a1 b8 08 00 00       	mov    0x8b8,%eax
 ...
 6c8:	a3 b8 08 00 00       	mov    %eax,0x8b8
 6cd:	c9                   	leave  
 6ce:	c3                   	ret    
...
000006cf <morecore>:
 ...
 720:	a1 b8 08 00 00       	mov    0x8b8,%eax
 725:	c9                   	leave  
 726:	c3                   	ret    
...
00000727 <malloc>:
 ...
 73c:	a1 b8 08 00 00       	mov    0x8b8,%eax
 741:	89 45 f0             	mov    %eax,-0x10(%ebp)
 744:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 748:	75 23                	jne    76d <malloc+0x46>
 74a:	c7 45 f0 b0 08 00 00 	movl   $0x8b0,-0x10(%ebp)
 751:	8b 45 f0             	mov    -0x10(%ebp),%eax
 754:	a3 b8 08 00 00       	mov    %eax,0x8b8
 759:	a1 b8 08 00 00       	mov    0x8b8,%eax
 75e:	a3 b0 08 00 00       	mov    %eax,0x8b0
 763:	c7 05 b4 08 00 00 00 	movl   $0x0,0x8b4
 76a:	00 00 00 
 ...
 7c0:	a3 b8 08 00 00       	mov    %eax,0x8b8
 7c5:	8b 45 f4             	mov    -0xc(%ebp),%eax
 7c8:	83 c0 08             	add    $0x8,%eax
 7cb:	eb 38                	jmp    805 <malloc+0xde>
 7cd:	a1 b8 08 00 00       	mov    0x8b8,%eax
