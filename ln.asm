...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3f2:	0f b6 80 c8 08 00 00 	movzbl 0x8c8(%eax),%eax
...
00000610 <free>:
 ...
 61f:	a1 e4 08 00 00       	mov    0x8e4,%eax
 ...
 6e0:	a3 e4 08 00 00       	mov    %eax,0x8e4
 6e5:	c9                   	leave  
 6e6:	c3                   	ret    
...
000006e7 <morecore>:
 ...
 738:	a1 e4 08 00 00       	mov    0x8e4,%eax
 73d:	c9                   	leave  
 73e:	c3                   	ret    
...
0000073f <malloc>:
 ...
 754:	a1 e4 08 00 00       	mov    0x8e4,%eax
 759:	89 45 f0             	mov    %eax,-0x10(%ebp)
 75c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 760:	75 23                	jne    785 <malloc+0x46>
 762:	c7 45 f0 dc 08 00 00 	movl   $0x8dc,-0x10(%ebp)
 769:	8b 45 f0             	mov    -0x10(%ebp),%eax
 76c:	a3 e4 08 00 00       	mov    %eax,0x8e4
 771:	a1 e4 08 00 00       	mov    0x8e4,%eax
 776:	a3 dc 08 00 00       	mov    %eax,0x8dc
 77b:	c7 05 e0 08 00 00 00 	movl   $0x0,0x8e0
 782:	00 00 00 
 ...
 7d8:	a3 e4 08 00 00       	mov    %eax,0x8e4
 7dd:	8b 45 f4             	mov    -0xc(%ebp),%eax
 7e0:	83 c0 08             	add    $0x8,%eax
 7e3:	eb 38                	jmp    81d <malloc+0xde>
 7e5:	a1 e4 08 00 00       	mov    0x8e4,%eax
