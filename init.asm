...
main(void)
{
  ...
  ae:	75 43                	jne    f3 <main+0xf3>
      exec("sh", argv);
  b0:	c7 44 24 04 8c 09 00 	movl   $0x98c,0x4(%esp)
  b7:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 48e:	0f b6 80 94 09 00 00 	movzbl 0x994(%eax),%eax
...
000006ac <free>:
 ...
 6bb:	a1 b0 09 00 00       	mov    0x9b0,%eax
 ...
 77c:	a3 b0 09 00 00       	mov    %eax,0x9b0
 781:	c9                   	leave  
 782:	c3                   	ret    
...
00000783 <morecore>:
 ...
 7d4:	a1 b0 09 00 00       	mov    0x9b0,%eax
 7d9:	c9                   	leave  
 7da:	c3                   	ret    
...
000007db <malloc>:
 ...
 7f0:	a1 b0 09 00 00       	mov    0x9b0,%eax
 7f5:	89 45 f0             	mov    %eax,-0x10(%ebp)
 7f8:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 7fc:	75 23                	jne    821 <malloc+0x46>
 7fe:	c7 45 f0 a8 09 00 00 	movl   $0x9a8,-0x10(%ebp)
 805:	8b 45 f0             	mov    -0x10(%ebp),%eax
 808:	a3 b0 09 00 00       	mov    %eax,0x9b0
 80d:	a1 b0 09 00 00       	mov    0x9b0,%eax
 812:	a3 a8 09 00 00       	mov    %eax,0x9a8
 817:	c7 05 ac 09 00 00 00 	movl   $0x0,0x9ac
 81e:	00 00 00 
