...
main(int argc, char *argv[])
{
  ...
  5a:	c7 44 24 04 3e 08 00 	movl   $0x83e,0x4(%esp)
  61:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3fa:	0f b6 80 dc 08 00 00 	movzbl 0x8dc(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 558:	75 27                	jne    581 <printf+0x120>
          s = "(null)";
 55a:	c7 45 e4 5a 08 00 00 	movl   $0x85a,-0x1c(%ebp)
        while(*s != 0){
...
00000618 <free>:
 ...
 627:	a1 f8 08 00 00       	mov    0x8f8,%eax
 ...
 6e8:	a3 f8 08 00 00       	mov    %eax,0x8f8
 6ed:	c9                   	leave  
 6ee:	c3                   	ret    
...
000006ef <morecore>:
 ...
 740:	a1 f8 08 00 00       	mov    0x8f8,%eax
 745:	c9                   	leave  
 746:	c3                   	ret    
...
00000747 <malloc>:
 ...
 75c:	a1 f8 08 00 00       	mov    0x8f8,%eax
 761:	89 45 f0             	mov    %eax,-0x10(%ebp)
 764:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 768:	75 23                	jne    78d <malloc+0x46>
 76a:	c7 45 f0 f0 08 00 00 	movl   $0x8f0,-0x10(%ebp)
 771:	8b 45 f0             	mov    -0x10(%ebp),%eax
 774:	a3 f8 08 00 00       	mov    %eax,0x8f8
 779:	a1 f8 08 00 00       	mov    0x8f8,%eax
 77e:	a3 f0 08 00 00       	mov    %eax,0x8f0
 783:	c7 05 f4 08 00 00 00 	movl   $0x0,0x8f4
 78a:	00 00 00 
 ...
 7e0:	a3 f8 08 00 00       	mov    %eax,0x8f8
 7e5:	8b 45 f4             	mov    -0xc(%ebp),%eax
 7e8:	83 c0 08             	add    $0x8,%eax
 7eb:	eb 38                	jmp    825 <malloc+0xde>
 7ed:	a1 f8 08 00 00       	mov    0x8f8,%eax
