...
grep(char *pattern, int fd)
{
  ...
  15:	01 45 ec             	add    %eax,-0x14(%ebp)
    p = buf;
  18:	c7 45 f0 e0 0b 00 00 	movl   $0xbe0,-0x10(%ebp)
    while((q = strchr(p, '\n')) != 0){
  ...
  8e:	75 91                	jne    21 <grep+0x21>
    ...
    if(p == buf)
  90:	81 7d f0 e0 0b 00 00 	cmpl   $0xbe0,-0x10(%ebp)
  ...
  a4:	7e 2b                	jle    d1 <grep+0xd1>
      m -= p - buf;
  a6:	ba e0 0b 00 00       	mov    $0xbe0,%edx
  ...
  c5:	c7 04 24 e0 0b 00 00 	movl   $0xbe0,(%esp)
  cc:	e8 9d 04 00 00       	call   56e <memmove>
{
  ...
  e2:	81 c2 e0 0b 00 00    	add    $0xbe0,%edx
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 6c6:	0f b6 80 ac 0b 00 00 	movzbl 0xbac(%eax),%eax
...
000008e4 <free>:
 ...
 8f3:	a1 c8 0b 00 00       	mov    0xbc8,%eax
 ...
 9b4:	a3 c8 0b 00 00       	mov    %eax,0xbc8
 9b9:	c9                   	leave  
 9ba:	c3                   	ret    
...
000009bb <morecore>:
 ...
 a0c:	a1 c8 0b 00 00       	mov    0xbc8,%eax
 a11:	c9                   	leave  
 a12:	c3                   	ret    
...
00000a13 <malloc>:
 ...
 a28:	a1 c8 0b 00 00       	mov    0xbc8,%eax
 a2d:	89 45 f0             	mov    %eax,-0x10(%ebp)
 a30:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 a34:	75 23                	jne    a59 <malloc+0x46>
 a36:	c7 45 f0 c0 0b 00 00 	movl   $0xbc0,-0x10(%ebp)
 a3d:	8b 45 f0             	mov    -0x10(%ebp),%eax
 a40:	a3 c8 0b 00 00       	mov    %eax,0xbc8
 a45:	a1 c8 0b 00 00       	mov    0xbc8,%eax
 a4a:	a3 c0 0b 00 00       	mov    %eax,0xbc0
 a4f:	c7 05 c4 0b 00 00 00 	movl   $0x0,0xbc4
 a56:	00 00 00 
