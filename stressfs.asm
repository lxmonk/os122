...
printint(int fd, int xx, int base, int sgn)
{
 ...
 52e:	0f b6 80 00 0a 00 00 	movzbl 0xa00(%eax),%eax
...
0000074c <free>:
 ...
 75b:	a1 1c 0a 00 00       	mov    0xa1c,%eax
 ...
 81c:	a3 1c 0a 00 00       	mov    %eax,0xa1c
 821:	c9                   	leave  
 822:	c3                   	ret    
...
00000823 <morecore>:
 ...
 874:	a1 1c 0a 00 00       	mov    0xa1c,%eax
 879:	c9                   	leave  
 87a:	c3                   	ret    
...
0000087b <malloc>:
 ...
 890:	a1 1c 0a 00 00       	mov    0xa1c,%eax
 895:	89 45 f0             	mov    %eax,-0x10(%ebp)
 898:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 89c:	75 23                	jne    8c1 <malloc+0x46>
 89e:	c7 45 f0 14 0a 00 00 	movl   $0xa14,-0x10(%ebp)
 8a5:	8b 45 f0             	mov    -0x10(%ebp),%eax
 8a8:	a3 1c 0a 00 00       	mov    %eax,0xa1c
 8ad:	a1 1c 0a 00 00       	mov    0xa1c,%eax
 8b2:	a3 14 0a 00 00       	mov    %eax,0xa14
 8b7:	c7 05 18 0a 00 00 00 	movl   $0x0,0xa18
 8be:	00 00 00 
